...
const RideCard = () => {
  return (
    <div onClick={() => router.push(`/ride-detail/${ride.id}`)}
      className="flex justify-between items-center shadow-md rounded-sm p-3 cursor-pointer"
    >
      <div className="flex items-center">
        ...
        <div className="ml-5 space-y-1">
          ...
          <p className="text-xs font-semibold opacity-60">cab KSLM9983</p>
