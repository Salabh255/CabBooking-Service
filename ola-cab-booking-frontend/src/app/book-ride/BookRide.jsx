    ...
    <div className='w-full'>
      ...
      <div className='px-3 lg:px-5 mt-10'>
        <form className='space-y-5' onSubmit={formik.handleSubmit}>
          <div>
            <div className="border p-2 flex items-center gap-3 relative">
              <p className="text-sm leading-none whitespace-nowrap">From</p>
              <input
                name="pickupLocation"
          ...
          <div>
            <div className="border p-2 flex items-center gap-3 relative">
              <p className="text-sm leading-none whitespace-nowrap">To</p>
              <input
              ...
              {activeField === "destinationLocation" && formik.values?.destinationLocation?.length>0 && (
                <div className="">
                  <SearchResult
                    setActiveField={setActiveField}
